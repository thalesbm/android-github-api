...
import br.tbm.github.api.controllers.GithubRateLimitController;
import br.tbm.github.api.entities.ResourcesResponse;

/**
 * Created by thalesbertolini on 04/09/2018
 **/
public class GithubRateLimitActivity extends BaseActivity<ResourcesResponse> {

    private GithubRateLimitController mController;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mController = new GithubRateLimitController(this);
