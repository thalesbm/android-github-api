...
import br.tbm.github.api.controllers.TagController;
import br.tbm.github.api.entities.BranchesTagsResponse;

/**
 * Created by thalesbertolini on 26/08/2018
 **/
public class TagFragment extends BaseFragment<BranchesTagsResponse> {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mController = new TagController(this);
