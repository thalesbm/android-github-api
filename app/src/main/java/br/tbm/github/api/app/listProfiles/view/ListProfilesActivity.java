...
import br.tbm.github.api.commons.view.components.CustomActionMode;
...
public class ListProfilesActivity extends BaseActivity<List<Profile>> implements
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search) {
            GithubRouter.redirectToSearchByUsernameActivity(this);
            return true;
        }

        if (id == R.id.action_rate_info) {
            GithubRouter.redirectToGithubRateLimitActivity(this);
            return true;
        }
...
//                    initializedSecondThreadIdlingResource();
    ...
    public void onClick(int position) {
        GithubRouter.redirectToProfileActivity(ListProfilesActivity.this, mProfiles.get(position), false);
    }
